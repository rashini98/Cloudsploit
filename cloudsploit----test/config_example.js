    ...
    credentials: {
        aws: {
            ...
            // OPTION 2: If using hard-coded credentials, enter them below
             access_key: process.env.AWS_ACCESS_KEY_ID || 'AKIA56NB5OTWQ5YTN57S',
             secret_access_key: process.env.AWS_SECRET_ACCESS_KEY || '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',
